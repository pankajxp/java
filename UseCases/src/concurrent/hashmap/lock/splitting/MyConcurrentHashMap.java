...
public class MyConcurrentHashMap<K, V> {
	...
	public static void main(String[] args) {
		MyConcurrentHashMap<Integer, String> myChm = new MyConcurrentHashMap<>(16);
		myChm.put(1, "john");
		myChm.put(2, "kapil");
		System.out.println("value for key 1 :" + myChm.get(1));
		System.out.println("value for key 2 :" + myChm.get(2));
	}
}
